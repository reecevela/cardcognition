...
class CardParser:
    def __init__(self):
        ...
        self.card_features = {
            ...
            "targeted_interaction": ["destroy target", "exile target", ["opponent sacrifices", "with the", "among"], "counter target", ["return", "target", "owner", "hand"], ["target", "into", "owner's", "library"]],
            ...
            "planeswalkers_matter": ["for each planeswalker", ["a planeswalker", "you control"], "planeswalker card", ["you cast", "planeswalker"], ["a planeswalker", "enters the battlefield"], ["planeswalker", "cost", "less to cast"], "planeswalkers"],
            ...
            "blink": [["exile target", "return", "to the battlefield"], ["exile CARDNAME", "return", "to the battlefield"], ["exile any number", "return", "to the battlefield"]],
            "ETB": ["enters the battlefield"],
            "hate": [["opponent", "can't", "cast"], ["opponent", "can't", "play"], ["opponent", "can't", "activate"], ["can't", "be sacrificed"], ["cost", "more to cast"], ["opponent", "enter", "tapped"], ["Whenever an opponent"]],
            "clone": ["as a copy of", ["a token", "copy of target"]],
            "forced_attack": ["must attack", "goad"],
            "redirect": ["change the target of", "choose new target"],
            "aura": ["aura"],
            "trigger_once": ["when "],
