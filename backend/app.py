...
app = Flask(__name__)
CORS(app, resources={r"/api/*": {"origins": ["http://cardcognition.com", "https://reecevela.github.io", "https://cardognition.com", "api.cardcognition.com", "https://api.cardcognition.com", "http://api.cardcognition.com"]}})
